...
let radioElems = document.querySelectorAll("input[type=radio][name=pattern]")
for (let radioElem of radioElems) {
    radioElem.addEventListener('change', () => {
        selectedPattern = document.querySelector('input[type=radio][name=pattern]:checked').value
    })
}